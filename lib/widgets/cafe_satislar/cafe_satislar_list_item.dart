...
class CafeSatislarListItem extends StatelessWidget {
  final Satis satis;
  const CafeSatislarListItem({
    Key? key,
    required this.satis,
  }) : super(key: key);
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return cafeSatislarList(snapshot.data!, context);
        }
      },
    );
  }

  Widget cafeSatislarList(DocumentSnapshot snapshot, BuildContext context) {
